...
void lancar_missao(asteroide *lista_asteroides, missao *lista_missoes, astronauta fila_astronauta[],  int *inicio, int *fim){
    ...
    int codigo_asteroide, verificador_asteroide, contagem_astronautas,i; 
    ...
    verificador_asteroide = verifica_codigo_asteroide(lista_asteroides, codigo_asteroide);
    printf("\n Resultado verificador asteroide: %d", verificador_asteroide);

   

    if(verificador_asteroide == -1){

        printf("\n Entrei no if verificador asteroide");
        ...
        if(missao_escolhida != NULL){
            ...
            /*Faço 3 desemfileiras colocando os astronautas dentro */
         ...
         if(contagem_astronautas >= 3){
            ...
            printf("\n Entrei no if contagem de astronautas");
